  ...
  const content = (
    <>
      <div className="relative overflow-hidden">
        <div className={clsx('relative overflow-hidden', variant === 'result' ? (compact ? 'aspect-16/11' : 'aspect-4/3') : 'aspect-4/3')}>
          {image ? (
      ...
      <div className={clsx('flex flex-1 flex-col', variant === 'result' ? (compact ? 'p-3.5 sm:p-4' : 'p-4 sm:p-5') : 'p-4 sm:p-5')}>
        <div className="flex items-start justify-between gap-3">
          <div className="min-w-0">
            ...
            <h3 className={clsx('mt-2 font-semibold tracking-[-0.03em] text-slate-900', variant === 'result' ? (compact ? 'text-base sm:text-lg' : 'text-lg sm:text-xl') : 'text-lg sm:text-xl')}>
              {listing.title}
            </h3>
          </div>
        ...
        <p className={clsx('mt-3 text-sm leading-6 text-slate-600', variant === 'result' && 'line-clamp-2')}>
